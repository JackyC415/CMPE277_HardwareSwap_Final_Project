...
public class thaitea extends AppCompatActivity {

    //constant price
    final double priceAmount = 1999.99;
    ...
    public void storeOrder()
    {
        confirms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.insert(newOrder);
                Intent goTO = new Intent(thaitea.this, Menu1.class);
                startActivity(goTO);
            }
        });
    }
