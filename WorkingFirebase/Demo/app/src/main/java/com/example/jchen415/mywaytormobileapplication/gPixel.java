...
public class gPixel extends AppCompatActivity {

    final double priceAmount = 899.99;
    TextView numorder;
    Button confirms;
    DBController db;
    ...
    public void storeOrder()
    {
        confirms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newOrder.setFoodName("Google Pixel");
                ...
                db.insert(newOrder);
                Intent goTO = new Intent(gPixel.this, Menu.class);
                startActivity(goTO);
            }
        });
    }
